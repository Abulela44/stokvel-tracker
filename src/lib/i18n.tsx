...
const en = {
  ...
  upload: "Upload",
  uploading: "Uploading...",
  fileTooBig: "This file is too large. Maximum size is {max}.",
  maxFileSize: "Maximum file size: {max}",
  uploadedCount: "Uploaded {count} file(s).",
  verifyTitle: "Security check",
  verifyHint: "For security we need your ID and proof of account before you can run a stokvel.",
  idDocument: "ID document (photo or PDF)",
  proofOfAccount: "Proof of account (bank letter or statement)",
  verifyMissing: "Please attach both your ID and proof of account.",
  verifySaved: "Documents received. We will review them shortly.",
  paymentDue: "Payment due",
  paymentSent: "Payment sent",
  paymentConfirmed: "Payment confirmed",
  paymentStatusLegend: "This month",
...
const xh: Record<Key, string> = {
  ...
  navAnnouncements: "Iindaba",
  navDocuments: "Amaxwebhu",
  navMore: "Okunye",
  moreTitle: "Okunye",
  announcementsTitle: "Ibhodi yezaziso",
  newAnnouncement: "Isaziso esitsha",
  noAnnouncements: "Akukho zaziso okwangoku.",
  documentsTitle: "Amaxwebhu",
  uploadDocument: "Layisha uxwebhu",
  fileTooBig: "Le fayile inkulu kakhulu. Ubukhulu obuvumelekileyo ngu-{max}.",
  maxFileSize: "Ubukhulu befayile obuvumelekileyo: {max}",
  uploadedCount: "Kulayishwe iifayile eziyi-{count}.",
  verifyTitle: "Ukhuseleko",
  verifyHint: "Ngenxa yokhuseleko sifuna isazisi sakho kunye nobungqina beakhawunti ngaphambi kokuqhuba istokvel.",
  idDocument: "Isazisi (ifoto okanye i-PDF)",
  proofOfAccount: "Ubungqina beakhawunti (ileta yebhanki okanye ingxelo)",
  verifyMissing: "Nceda ufake isazisi kunye nobungqina beakhawunti.",
  verifySaved: "Amaxwebhu afunyenwe. Siza kuwahlola kungekudala.",
  paymentDue: "Kufuneka intlawulo",
  paymentSent: "Intlawulo ithunyelwe",
  paymentConfirmed: "Intlawulo iqinisekisiwe",
  paymentStatusLegend: "Le nyanga",
  noDocuments: "Akukho maxwebhu okwangoku.",
  proofTitle: "Ubungqina bentlawulo",
  uploadProof: "Layisha ubungqina",
  noProofs: "Akukho bungqina okwangoku.",
  activityTitle: "Izenzo zakutsha nje",
  noActivity: "Akukho nto yenzekileyo okwangoku.",
  statusPending: "Kulindile",
  statusApproved: "Kwamkelwe",
  statusRejected: "Kwaliwe",
  approve: "Yamkela",
  reject: "Yala",
  view: "Jonga",
  delete: "Cima",
...
const zu: Record<Key, string> = {
  ...
  navAnnouncements: "Izindaba",
  navDocuments: "Amadokhumenti",
  navMore: "Okunye",
  moreTitle: "Okunye",
  announcementsTitle: "Ibhodi lezaziso",
  newAnnouncement: "Isaziso esisha",
  noAnnouncements: "Azikho izaziso okwamanje.",
  documentsTitle: "Amadokhumenti",
  uploadDocument: "Layisha idokhumenti",
  fileTooBig: "Leli fayela likhulu kakhulu. Ubukhulu obuvumelekile ngu-{max}.",
  maxFileSize: "Ubukhulu befayela obuvumelekile: {max}",
  uploadedCount: "Kulayishwe amafayela angu-{count}.",
  verifyTitle: "Ukuphepha",
  verifyHint: "Ngenxa yokuphepha sidinga umazisi wakho kanye nobufakazi be-akhawunti ngaphambi kokuqhuba istokvel.",
  idDocument: "Umazisi (isithombe noma i-PDF)",
  proofOfAccount: "Ubufakazi be-akhawunti (incwadi yebhange noma isitatimende)",
  verifyMissing: "Sicela ufake umazisi kanye nobufakazi be-akhawunti.",
  verifySaved: "Amadokhumenti atholakele. Sizowahlola maduze.",
  paymentDue: "Inkokhelo iyadingeka",
  paymentSent: "Inkokhelo ithunyelwe",
  paymentConfirmed: "Inkokhelo iqinisekisiwe",
  paymentStatusLegend: "Le nyanga",
  noDocuments: "Awekho amadokhumenti okwamanje.",
  proofTitle: "Ubufakazi benkokhelo",
  uploadProof: "Layisha ubufakazi",
  noProofs: "Abukho ubufakazi okwamanje.",
  activityTitle: "Okwenzeke muva",
  noActivity: "Akukho lutho olwenzekile okwamanje.",
  statusPending: "Kulindile",
  statusApproved: "Kwamukelwe",
  statusRejected: "Kwenqatshwe",
  approve: "Yamukela",
  reject: "Yenqaba",
  view: "Buka",
  delete: "Susa",
